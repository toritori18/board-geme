...
export default function SetPasswordPage() {
  ...
  if (!ready) {
    return (
      <>
        <Head>
          <title>パスワード初期設定 | ボードゲームランキング</title>
        </Head>
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="set-password-new" className="block text-sm font-medium text-gray-700 mb-1">パスワード</label>
              ...
              <div>
                <label htmlFor="set-password-confirm" className="block text-sm font-medium text-gray-700 mb-1">パスワード（確認）</label>
                <div className="relative">
                  <input
